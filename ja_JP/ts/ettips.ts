...
Before using this feature, first set security on the sheet by using the protect sheet command.</oldsource>
        ...
        <translatorcomment>保護されたブック、シート内において、一部範囲のみ編集できるよう設定します。</translatorcomment>
        <translation>指定されたユーザーのみ保護されたブックやシート上のセル範囲を編集できます。

この機能を使用する前に、シート保護のコマンドを使用してシートのセキュリティ設定を行ってください。</translation>
    </message>
    ...
    <message id="ArtisticWordAlignment.content">
        ...
        <translatorcomment>選択したアート文字の配置を設定します</translatorcomment>
        <translation>複数行ワードアートの整列方法を指定します。</translation>
    </message>
...
This is only necessary if automatic calculation has been turned off.</source>
        ...
        <translation>現在のシートで今すぐ計算を実行します。

自動計算を有効にしている場合、このコマンドを使用する必要がありません。</translation>
    </message>
    ...
    <message id="Camera.content">
        ...
        <translation>選択されたデータ範囲を図で表示できます。ソースデータを変更するとキャプチャされた図の上のデータも変更されることになります。</translation>
    </message>
    ...
    <message id="ChartObjects.title">
        ...
        <translation>表オブジェクトの選択</translation>
    </message>
    <message id="ChartObjects.content">
        ...
        <translation>表全体や表内のオブジェクトを選択できます</translation>
    </message>
    <message id="ChineseTranslation.title">
        ...
        <translation>ChineseTranslation Title</translation>
    </message>
    <message id="ChineseTranslation.content">
        ...
        <translatorcomment>転換単位を詳細に設定可能です（文字列か単語より転換します）</translatorcomment>
        <translation>繁体字-簡体字中国語の文字・単語の翻訳単位を決めます。</translation>
    </message>
...
Double-click an item in the list of results to switch the corresponding cell.</source>
    ...
    <message id="CommaStyle.content">
        ...
        <translation>選択したセルに桁区切り記号を付けます。</translation>
    </message>
...
For instance, choose Euros instead of Dollars.</source>
    ...
    <message id="DataDetailedSettings.title">
        ...
        <translation>データの詳細設定</translation>
    </message>
    <message id="DataDetailedSettings.content">
        ...
        <translation>アウトラインの詳細設定を変更します。</translation>
    </message>
...
Press Esc on the keyboard or click this option again to exit the drawing mode.</oldsource>
        ...
        <translatorcomment>マウス操作にてセルの罫線を追加します。</translatorcomment>
        <translation>罫線を引くには、クリック後にマウスを動かして描画してください。

キーボードの「ESC」キーを押すか、マウスをダブルクリックすることで描画モードを解除できます。</translation>
    </message>
...
キーボードの「ESC」キーを押すか、マウスをダブルクリックすることで描画モードを解除できます。</translation>
    ...
    <message id="DrawingToolsDetailedSettings.title">
        ...
        <translation>描画ツールの詳細設定</translation>
    </message>
...
Press Esc on the keyboard or click this option again to exit the erasing mode.</oldsource>
        ...
        <translation>罫線を消すには、クリック後にマウスを動かして消去してください。

キーボードの「ESC」キーを押すか、マウスをダブルクリックすることで消去モードを解除できます。</translation>
    </message>
    ...
    <message id="FTB_Property.content">
        ...
        <translation>選択したコントロールのプロパティを表示または変更します。</translation>
    </message>
...
The information in the header or footer will appear at the top or bottom of each printed page.</source>
    ...
    <message id="HomeDetailedSettings.content">
        ...
        <translation>セル書式などの設定を変更します。</translation>
    </message>
    ...
    <message id="InsertClipArt.content">
        ...
        <translatorcomment>「クリップアート」ワークウィンドウが表示されます。あらかじめ用意されたイラストの挿入ができます。</translatorcomment>
        <translation>図面、動画、音楽や写真などを含めて特定の概念を説明するために、クリップアートをシートに挿入できます。</translation>
    </message>
    ...
    <message id="InsertFileObject.content">
        ...
        <translation>既存のファイルを挿入し、スライド内でアイコンで表示します</translation>
    </message>
...
選択した行の上に挿入されます。</translation>
    ...
    <message id="MergeCenter.content">
        ...
        <translatorcomment>選択したセルを全て結合して1つにし、セル内の文字列を中央揃えで配置します</translatorcomment>
        <translation>選択したセルを1つの大きなセルに結合し、新しいセルの内容を中心に配置します。</translation>
    </message>
    ...
    <message id="MergeCenter2.content">
        ...
        <translatorcomment>選択した複数セルを結合します。▼をクリックすると詳細を選択できます</translatorcomment>
        <translation>選択したセルを1つの大きなセルに結合し、新しいセルの内容を中心に配置します。</translation>
    </message>
...
The field list allows you to add and remove fields.</oldsource>
        ...
        <translation>フィールドリストの表示/非表示を切り替えます。

フィールドリストからのフィールド追加、削除も可能です。</translation>
    </message>
    ...
    <message id="PageLayoutDetailedSettings.title">
        ...
        <translation>ページレイアウトの詳細設定</translation>
    </message>
    <message id="PageLayoutDetailedSettings.content">
        ...
        <translation>ページ設定等の設定を変更します。</translation>
    </message>
...
Column headings are the letters or numbers that appear above the columns on a sheet.</source>
    ...
    <message id="PrintPreview.content">
        ...
        <translation>印刷したいファイルの出力効果をプレビューします</translation>
    </message>
...
You can specify a password that can be entered to unprotect the sheet and allow these changes.</source>
    ...
    <message id="RB_Clipboard.content">
        ...
        <translation>コピー＆ペーストで移動するデータの一時保存ができる場所です</translation>
    </message>
...
Click the arrow to pick a different color.</source>
        ...
        <translation>選択されているセルの行と列の位置が塗りつぶし表示されます
...
This is only necessary if automatic calculation has been turned off.</source>
        ...
        <translation>ブック全体で今すぐ計算を行います。

自動計算を有効にしている場合、こちらの操作は不要です。</translation>
    </message>
    ...
    <message id="RecenttlyUsed.content">
        ...
        <translation>最近使用した関数の一覧が表示されます。一覧から選択した関数を挿入できます。</translation>
    </message>
    ...
    <message id="RecordMacro.content">
        ...
        <translation>「マクロ作成」ボックスが表示されてマクロを作成開始します</translation>
    </message>
    ...
    <message id="RelativeReference.title">
        ...
        <translation>相対参照を使用</translation>
    </message>
    <message id="RelativeReference.content">
        ...
        <translation>相対参照の使用よりマクロの操作は初期で選択されたセルに相対参照させます</translation>
    </message>
    ...
    <message id="RowsAndColumn.content">
        ...
        <translation>行と列を調整するにはここをクリックしてください。
高さや幅の調整したり、塗りつぶしを変更したり、行や列を非表示にすることができます。</translation>
    </message>
...
You can use this feature to view multiple distant panes of your worksheet at once.</oldsource>
        ...
        <translatorcomment>指定したセルの位置でシートが分割表示され、それぞれスクロールバーで操作できるようになります。</translatorcomment>
        <translation>指定したセルの位置でシートが分割表示されます。

シート内の離れた場所を表示するために、この機能を使用することができます。</translation>
    </message>
    ...
    <message id="StopRecordMacro.content">
        ...
        <translation>マクロの作成を中止します</translation>
    </message>
    ...
    <message id="Subtotals.content">
        ...
        <translation>選択したデータから特定の項目ごとの集計ができます。</translation>
    </message>
...
In Writer, use this feature to convert the selected text into a table, splitting the text into columns at each comma, period, or other character you specify.</source>
    ...
    <message id="TranslateToSimplifiedChinese.title">
        ...
        <translation>TranslateToSimplifiedChinese Title</translation>
    </message>
    <message id="TranslateToSimplifiedChinese.content">
        ...
        <translation>TranslateToSimplifiedChinese Content</translation>
    </message>
    <message id="TranslateToTraditionalChinese.title">
        ...
        <translation>TranslateToTraditionalChinese Title</translation>
    </message>
    <message id="TranslateToTraditionalChinese.content">
        ...
        <translation>TranslateToTraditionalChinese Content</translation>
    </message>
...
You can also force input to be chosen from a dropdown list of values you specify.</source>
        ...
        <translation>セル内に入力できるデータの制限範囲を設定します</translation>
    </message>
...
What-If Analysis tool that finds the optimal value of a target cell by changing values in cells used to calculate the target cell.</source>
        ...
        <translation>「ゴールシーク」では、目的の結果が得られる最適な代入値が見つかります。

「ソルバー」は目的セルの計算に使用されるセルの値を変更することで、目的セルの最適値を求めます。</translation>
    </message>
    ...
    <message id="WorkSheet.content">
        ...
        <translatorcomment>シートの設定ができます。
▼をクリックすると、シートの挿入、削除、名前の変更などが可能です。</translatorcomment>
        <translation>シートの設定変更ができます。シートの挿入・削除やシート名の変更、シートタブ色の変更が可能です。</translation>
    </message>
    ...
    <message id="WorkSpace_Backup.content">
        ...
        <translatorcomment>ファイルを閉じる前にそのファイルを「ファイルロッカーボックス」にバックアップをするためには、ドキュメントの回復を開いて下さい。</translatorcomment>
        <translation>現在のファイルについて、自動または手動バックアップの設定をしてください。バックアップはファイルセーフに保存されます。</translation>
    </message>
    ...
    <message id="m_Format.content">
        ...
        <translatorcomment>選択したセルの高さや幅の変更、シートの整理、セルの保護や表示/非表示の設定ができます。</translatorcomment>
        <translation>選択したセルの設定変更をすることにより、文字列を数字やハイパーリンクに変換できます。</translation>
    </message>
    ...
    <message id="sp_ConditionHighlight.content">
        ...
        <translation>条件を満たすセルを強調表示します。</translation>
    </message>
    ...
    <message id="sp_AutoSum.content">
        ...
        <translation>選択したセルに合計を選択したセルの後に表示します。</translation>
    </message>
...
▼をクリックすると、その他の関数を挿入することもできます。</translation>
    ...
    <message id="FormulaErrorCheck.content">
        ...
        <translation>数式で発生する一般的なエラーをチェックします。</translation>
    </message>
...
Data Tables allow you to see the results of many different possible inputs at the same time.</oldsource>
        ...
        <translation>What-if分析ツールは、目的セルの計算に使用されるセルの値を変更することで、目的セルの最適値を求めます。</translation>
    </message>
    ...
    <message id="PTRepeatLabels.content">
        ...
        <translation>すべての親アイテムラベルを表示</translation>
    </message>
    ...
    <message id="PTNotRepeatLabels.content">
        ...
        <translation>親アイテムのラベルを繰り返す場合、一つのアイテムだけを表示する。</translation>
    </message>
...
Click the arrow to see the different types of line charts available and pause the pointer on the icons to see a preview in your document.</source>
        <translation>折れ線グラフは、時間の経過に伴う変化を表すのに使用します。

▼をクリックすると、その他の折れ線グラフを表示できます。</translation>
    </message>
...
▼をクリックすると、その他の散布図またはパブルグラフを表示できます。</translation>
    ...
    <message id="Accounting.content">
        ...
        <translation>選択したセルに対して通貨形式を選択します。</translation>
    </message>
    <message id="CellStyleGallery.title">
        <source>Cell Styles</source>
        <translation>セルのスタイル</translation>
    </message>
...
これにより、見やすいレイアウトになります。</translation>
    ...
    <message id="ChangeChartType.content">
        ...
        <oldsource>Change the current chart type.</oldsource>
...
Click the arrow to select different fill effects.</source>
    ...
    <message id="GraphicFillColor2.content">
        ...
        <translation type="unfinished">図形の塗りつぶしをします</translation>
    </message>
...
Click the arrow to select detailed settings for the outline.</source>
    ...
    <message id="GraphicLineColor2.content">
        ...
        <translation type="unfinished">図形の外枠を設定します</translation>
    </message>
