...
Layout</source>
    ...
    <message>
        ...
        <comment>WP_OPENFILE</comment>
        <translation>Alle Dateien(*.*)|*.*|Gemeinsame Dateien(*.dps; *.dpt; *.ppt; *.pps; *.pot; *.pptx)|*.dps; *.dpt; *.ppt; *.pps; *.pot; *.pptx|WPS-Präsentationsdateien(*.dps)|*.dps|WPS-Präsentationsvorlagen(*.dpt)|*.dpt|Microsoft PowerPoint 97/2000/XP/2003-Präsentationen(*.ppt; *.pps)|*.ppt; *.pps|Microsoft PowerPoint 97/2000/XP/2003 Präsentationsvorlagen(*.pot)|*.pot|Microsoft PowerPoint 2007/2010 Präsentationen(*.pptx; *.ppsx)|*.pptx; *.ppsx</translation>
    </message>
    <message>
